...
1. [Download GOAT-0.1.2.dmg](https://github.com/goatsoft/GOAT/releases/download/v0.1.2/GOAT-0.1.2.dmg) from the official [Kid release](https://github.com/goatsoft/GOAT/releases/tag/v0.1.2).
