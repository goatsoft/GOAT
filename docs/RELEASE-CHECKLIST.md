...
- Qualify automatic uninstall with the final signed/notarized app: copied-helper execution, keep options, cancellation, other-instance exclusion, recovery records and app/CLI Trash handling. Use disposable installations and data; never interrupt active work.
