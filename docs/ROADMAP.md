...
Live engine and checkpoint qualification remains separate. A Qwen3.8 27B 4-bit trial showed strong reasoning and tool selection but did not complete the Aurora repair. It also exposed an unclear effective output ceiling and a manual compaction that remained busy for more than 20 minutes. The [oMLX status and generation ownership proposal](adrs/0090-omlx-capability-status-and-generation-ownership.md) and the maintenance backlog cover those usability gaps.
