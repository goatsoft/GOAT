...
PRs #35 and #36 are merged; issues #29, #31 and #33 are closed. Compaction controls passed their keyboard, reduced-motion and restart checks in #24. The [engine contract](ENGINES.md#maintenance-qualification-20-september-2026) records live model and memory qualification and its limits. Current delivery state is tracked on the [project board](https://github.com/orgs/goatsoft/projects/1). PR #40 is merged and qualification issues #26 and #30 are closed. The next usability maintenance work is live throughput [#38](https://github.com/goatsoft/GOAT/issues/38): distinguish received output from server generation, measure delivery and UI publication delays, and fix demonstrated bottlenecks. Stable oMLX 0.6.4 remains the baseline. Test-harness cleanup #28, native delegation #32 and the maintained Xcode project workflow [#39](https://github.com/goatsoft/GOAT/issues/39) remain separate backlog work. A release version and publication are not assigned by this scope. The XcodeGen source-of-truth rule remains in effect.
