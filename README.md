...
**0.1.2 is in preparation:** model management, resilient long conversations, clearer engine diagnostics and a maintained Xcode and test workflow. Read the [draft release notes](docs/RELEASE-NOTES.md#kid-0-1-2-in-preparation) and [maintenance roadmap](docs/ROADMAP.md#kid-012-maintenance-release).
