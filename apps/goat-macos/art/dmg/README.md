...
The CLI recess sits below and to the right of the app recess with a visible gap. Finder retains dark native filename labels over picture backgrounds; the artwork intentionally has no added label backings.
