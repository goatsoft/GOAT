...
extension AppTests.Bleet {
    @Suite struct ComposerResponsivenessTests {
        ...
        @Test @MainActor func composerAcceptsDraftAndUndoWhileGenerationOwnsSend() async throws {
            ...
            let host = NSHostingView(
                rootView: ComposerFixture(state: state, session: session).environment(AppModel.shared))
...
extension AppTests.Bleet {
    @Suite struct ComposerReadinessTests {
