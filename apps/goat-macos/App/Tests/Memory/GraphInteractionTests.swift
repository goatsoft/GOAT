...
extension AppTests.Memory {
    @Suite struct GraphInteractionTests {
        ...
        @Test @MainActor func nativeMapClicksActivateScrollAndLeavingReturnsScrollToThePage() throws {
            ...
            let click = try #require(
                NSEvent.mouseEvent(
                    with: .leftMouseDown, location: NSPoint(x: 100, y: 100), modifierFlags: [], timestamp: 0,
                    windowNumber: 0,
        ...
        @Test @MainActor func legendHoverAndClickHelpNeverClaimKeyboardFocus() throws {
            ...
            let event = try #require(
                NSEvent.mouseEvent(
                    with: .mouseMoved, location: NSPoint(x: 10, y: 10), modifierFlags: [], timestamp: 0,
                    windowNumber: 0,
