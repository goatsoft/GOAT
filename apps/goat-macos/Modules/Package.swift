...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(name: "GOATedTests", dependencies: ["GOATed", "Tools"]),
        .testTarget(name: "PronkTests", dependencies: ["Pronk", "GOATed", "Tools"]),
        .testTarget(name: "HitchTests", dependencies: ["Hitch"]),
        .testTarget(name: "InferenceTests", dependencies: ["Herd", "Inference"]),
        .testTarget(name: "BleetTests", dependencies: ["Bleet"]),
